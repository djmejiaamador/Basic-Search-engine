...
public class WorkQueue {
	...
	public WorkQueue(int threads) {
		...
		log.debug("work queue started with:{}", workers.length);
	}
	...
	/**
	 * decreases number of tasks in the queue calls notify all once pending is 0
	 * or less and wakes up the sleeping threads;
	 */
